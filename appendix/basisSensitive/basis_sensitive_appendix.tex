...
\begin{proof}
    Let $\vec{b_i}$, the basis vectors of $B$. And $\sum_i^n\alpha_i \vec{b_i}$, $\sum_i=1^n \beta^i \vec{b_i}$ decompositions of $\vec{v}$ onto $B$. Then we have:
    \[\vec{v} - \vec{v} = 0 \cdot \vec{v} = \sum_{i=1}^{n} (\alpha_i - \beta_i) \vec{b_i}\]
...
\begin{proof}
    ...
    \begin{align*}
        &\scal{\vec{w_1}}{\vec{w_2}} \\
        &= \scal{\vec{w_{11}}}{\vec{w_{22}} + 0\cdot\vec{w_{12}} + 0\cdot\vec{w_{01}} + 0\cdot\vec{w_{11}}}\\
