...
\begin{abstract}
  ...
  respect to arbitrary---possibly entangled---bases, combining higher-order
  quantum control and a realisability semantics ensuring unitarity by construction.
  Each abstraction and
