...
that type. Each typing rule thus corresponds to a provable theorem. Rather than
...
extracted type system acts as a logical filter: only terms reducing to
unit-norm values and representing unitary transformations are typable.
