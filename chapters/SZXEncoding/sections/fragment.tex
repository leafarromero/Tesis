...
\begin{table*}
    \begin{align*}
        A &:= S \;|\; P \;|\; (n: \nat) \to A[n]&\\
        S &:= \bit \;|\; \qubit \;|\;\unit \;|\; S_1 \otimes S_2 \;|\; S_1 \multimap S_2 \;|&\\
        & \qquad\typeVec{S}{(n: \nat)}&\\
        P &:= \nat \;|\; \typeVec{\nat}{(n: \nat)}&
    \end{align*}
...
\begin{table}
    \small
    \[
        \infer[\mathsf{ax}]{\TYP{\Phi, x:A}{x}{A}}{} \qquad
        \infer[\mathsf{ax_0}]{\TYP{\Phi}{0}{\bit}}{} \qquad
        \infer[\mathsf{ax_1}]{\TYP{\Phi}{1}{\bit}}{} \qquad
    \]
    
    \[
        \infer[\mathsf{ax}_n]{\TYP{\Phi}{n}{\nat}}{n\in\mathbb{N}} \qquad
        \infer[\square]{\TYP{\Phi}{M\square N}{\nat}}
        {\TYP{\Phi}{M}{\nat} & \TYP{\Phi}{N}{\nat}}
    \]
    
    \[
        \infer[\mathsf{meas}]{\TYP{\Phi}{\meas}{\qubit\multimap\bit}}{} \qquad
        \infer[\mathsf{new}]{\TYP{\Phi}{\new}{\bit\multimap\qubit}}{}
    \]
