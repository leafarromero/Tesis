...
{\centering
    ...
    Name & Encoding \\
    \hline
    Rz(n) & $\tikzfig{judgements/unitaries/rz}$ \\[5pt]
    Rz$^{-1}$(n) & $\tikzfig{judgements/unitaries/rz-inv}$ \\[5pt]
    Rx(n) & $\tikzfig{judgements/unitaries/rx}$ \\[5pt]
    Rx$^{-1}$(n) & $\tikzfig{judgements/unitaries/rx-inv}$ \\[5pt]
    H & $\tikzfig{judgements/unitaries/hadamard}$ \\[5pt]
    CNOT & $\tikzfig{judgements/unitaries/cnot}$ \\[5pt]
    \hline
    \end{tabular}
    \par
}
...
{\color{red} PARRAFO EXPLICANDO EL ACCUMAP QUE ES MEDIO COMPLICADO}
