...
\ref{tab:Syntax}. The calculus is divided into four
...
\begin{table}[t]
  \begin{align*}
    ...
    \LetP{x}{B_1}{y}{B_2}{\vv{t}}{\vv{t}} & \\[5pt]
    & \qquad\gencase{\vv{t}}{\vv{v}}{\vv{v}}{\vv{t}}{\vv{t}} &
    (\Lambda) \\[5pt]
    \vv{v} &::= v \mid \vv{v}+\vv{v} \mid \alpha \vv{v} \mid \vv 0
    \qquad\hfill(\alpha\in\C) & (\ValD) \\[5pt]
...
\begin{table}[t]
  ...
  \begin{align*}
    ...
    \equiv \alpha(\LetP{x_1}{X}{x_2}{Y}{\vv{t}}{\vv{s}})\\[7pt]
    &\LetP{x_1}{X}{x_2}{Y}{\vv{t}+\vv{s}}{\vv{r}}
    \equiv\\
      &\qquad(\LetP{x_1}{X}{x_2}{Y}{\vv{t}}{\vv{r}})
      +(\LetP{x_1}{X}{x_2}{Y}{\vv{s}}{\vv{r}})\\[7pt]
    &\gencase{\alpha \vv{t}}{\vv{v_1}}{\vv{v_n}}{\vv{s_1}}{\vv{s_n}}
    \equiv \alpha(\gencase{\vv{t}}{\vv{v_1}}{\vv{v_n}}{\vv{s_1}}{\vv{s_n}})\\[7pt]
    &\gencase{(\vv{t}+\vv{s})}{\vv{v}}{\vv{w}}{\vv{r_1}}{\vv{r_2}}
    \equiv\\
    &\qquad\gencase{\vv{t}}{\vv{v}}{\vv{w}}{\vv{r_1}}{\vv{r_2}}
...
The rules in \ref{tab:Congruence} ensure that the
...
congruence in \ref{tab:Congruence}.  
...
\begin{definition}[Basis]\label{def:NthDimensionalBasis}
  ...
  \begin{enumerate}
    \item Each element of $B$ is an $n$-dimensional qubit \emph{(cf.~\ref{def:Qubit})}.
    \item Distinct elements of $B$ are pairwise orthogonal.
  \end{enumerate}
\end{definition}

From now on, the syntax introduced in \ref{tab:Syntax}
