...
{\color{red} ACÁ HABLAR UN POCO MÁS EN PROFUNDIDAD DEL TÉRMINO. MENCIONAR EL TIPADO.}

The term directly correlates the result of the bell basis measurement with the corresponding correction without the need for a decomposition. The $\lambdaB$ calculus provides syntax which allows the abstraction of the steps encoding and decoding on the Bell basis. This technique makes full use of the deferred measurement principle and can be applied to measurements on arbitrary bases.
