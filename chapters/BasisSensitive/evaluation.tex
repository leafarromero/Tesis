...
\begin{proof}
  ...
  \begin{description}
    ...
    If $\vec{t} = (\Lam{x}{B}{\vec{t_1}})$ and $\vec{s}=\vec{v}$ and $\vec{t_1}\ansubst{\vec{v}/x}{B}$, is defined then (we consider the case $B\neq\AbsBasis$):
    \begin{align*}
      (\Lam{x}{B}{\vec{t_i}}) (\alpha\vec{v}) &\evalone \vec{t_1}\ansubst{\alpha\vec{v}/x}{B}\\
      &= \sum_{i=1}^{n} \alpha\beta_i \vec{t_1}[\vec{b_i}/x]\quad \text{with }\vec{v}\equiv\sum_{i=1}^{n} \beta_i \vec{b_i} \text{ with } \vec{b_i}\in B\\
    \end{align*}
    On the other side:
    \begin{align*}
      \alpha ((\Lam{x}{B}{\vec{t_1}}) \vec{v}) &\evalone \alpha(\vec{t_1}\ansubst{\vec{v}}{B})\\
      &=\alpha(\sum_{i=1}^{n} \beta_i \vec{t_1}[\vec{b_i}/x])\quad \text{with }\vec{v}\equiv\sum_{i=1}^{n} \beta_i \vec{b_i} \text{ with } \vec{b_i}\in B\\
    \end{align*}
    ...
    If $\vec{t} = (\Lam{x}{B}{\vec{t_1}})$, $\vec{s}=\vec{v}$, and $\vec{r}=\vec{w}$ with
    $\vec{t_1}\ansubst{\vec{v}/x}{B}$ and $\vec{t_1}\ansubst{\vec{w}/x}{B}$ defined then (we consider the case where $B\neq\AbsBasis$):
    \begin{align*}
      (\Lam{x}{B}{\vec{t_1}}) (\vec{v}+\vec{w}) &\evalone \vec{t_1}\ansubst{\vec{v}+\vec{w}/x}{B}\\
      &=\sum_{i=1}^{n}(\alpha_i+\beta_i)\vec{t_1}[\vec{b_i}/x]\\
      &\quad\text{where }\vec{v}\equiv\sum_{i=1}^{n}\alpha_i\vec{b_i},\vec{w}\equiv\sum_{i=1}^{n}\beta_i\vec{b_i}\text{ with }\vec{b_i}\in B 
    \end{align*}
    ...
    \begin{align*}
      ...
      &=\sum_{i=1}^{n}(\alpha_i)\vec{t_1}[\vec{b_i}/x] + =\sum_{i=1}^{n}(\alpha_i)\vec{t_1}[\vec{b_i}/x]\\
      &\quad\text{where }\vec{v}\equiv\sum_{i=1}^{n}\alpha_i\vec{b_i},\vec{w}\equiv\sum_{i=1}^{n}\beta_i\vec{b_i}\text{ with }\vec{b_i}\in B 
    \end{align*}
    ...
    &\text{where: }\vec{v}\equiv\sum_{i=1}^n\beta_i\Pair{\vec{v_i}}{\vec{w_i}} \text{ with } \vec{v_i}\in B_1, \vec{w_i}\in B_2
    \end{align*}
    On the other side;
    \begin{align*}
    ...
    \item[\parbox{.75\linewidth}{\begin{align*}
      ...
      \begin{align*}
      \LetP{x_1}{B_1}{x_2}{B_2}{\vec{v}+\vec{w}}{\vec{r}}&\evalone\vec{r}\ansubst{\vec{v}+\vec{w}/x_1\otimes x_2}{B_1\otimes B_2}\\
      &=\sum_{i=1}^n (\alpha_i+\beta_i) \vec{r}[\vec{v_i}/x_1][\vec{w_i}/x_2]\\
      &\text{where: }\vec{v}\equiv\sum_{i=1}^n\alpha_i\Pair{\vec{v_i}}{\vec{w_i}} \text{ with } \vec{v_i}\in B_1, \vec{w_i}\in B_2\\
      &\text{and: }\vec{w}\equiv\sum_{i=1}^n\beta_i\Pair{\vec{v_i}}{\vec{w_i}} \text{ with } \vec{v_i}\in B_1, \vec{w_i}\in B_2\\
      \end{align*}
    ...
    If $\vec{t}=\vec{v}\equiv\sum_{i=1}^n\beta_i \vec{v_i}$. Then:
    \begin{align*}
    ...
    If $\vec{t}=\vec{v}\equiv\sum_{i=1}^n\alpha_i \vec{v_i}$, and $\vec{s}=\vec{w}\equiv\sum_{i=1}^n\beta_i \vec{v_i}$. Then:
    \begin{align*}
