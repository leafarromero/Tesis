...
The reduction system implements a mechanism where every vector in the space is read in the corresponding basis attached to the abstracion. It does this by allowing an evaluation step only when the argument can be decomposed onto that basis. The system works modulo the congruence defined in Table \ref{tab:Congruence}. We describe it in detail in Table \ref{tab:Reduction}.
...
\begin{table*}[tb]
  ...
  \[
  \begin{array}{c}
      \infer{\gencase{\vec t}{\vec v}{\vec w}{\vec s_1}{\vec s_2}\lra \gencase{\vec r}{\vec v}{\vec w}{\vec s_1}{\vec s_2}}{t\lra \vec r}
  \end{array}
  \]
