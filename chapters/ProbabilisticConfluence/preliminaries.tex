...
% Definición de confluencia tradicional TODO:
...
%Let's take the example a step further and pass the multiplication function as an argument. In this case, both results yield 0, 1 but with different probabilities

% [Tikzcd pasando multiplicación como argumento]

% No solo nos interesa llegar al mismo resultado, sino que también nos interesa que ambas ramas tengan la misma probabilidad
